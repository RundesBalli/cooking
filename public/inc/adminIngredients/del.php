...
if(!empty($_GET['id'])) {
  ...
  if(mysqli_num_rows($result) == 0) {
    ...
    if(!isset($_POST['submit'])) {
       ...
       */
      $content.= "<div class='row'>".
      "<div class='col-s-12 col-l-12'>Soll die Zutat <span class='italic highlight'>".output($row['title'])."</span> wirklich gelöscht werden? Dies funktioniert nur, wenn sie in keinem Rezept verwendet wird.</div>".
      "</div>";
      /**
      ...
      $content.= "<form action='/adminIngredients/del?id=".$id."' method='post' autocomplete='off'>";
