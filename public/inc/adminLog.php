...
while($row = mysqli_fetch_array($result)) {
  ...
  "<div class='col-x-4 col-s-4 col-m-5 col-l-5 col-xl-2'>".($row['username'] === NULL ? "-" : ($row['username'] == $username ? "<span class='highlight'>".output($row['username'])."</span>" : output($row['username'])))."</div>".PHP_EOL.
