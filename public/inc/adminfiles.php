            ...
            if($_POST['type'] == 'thumb') {
              ...
              if(mysqli_num_rows($result) == 2) {
                ...
                if($width < 1500 OR $height < 1500) {
                   ...
                   */
                  mysqli_query($dbl, "INSERT INTO `images` (`itemid`, `thumb`) VALUES ('".$id."', 0)") OR DIE(MYSQLI_ERROR($dbl));
